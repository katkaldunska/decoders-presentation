...
let AppComponent = class AppComponent {
    ...
    setCurrentSlide(increment) {
        const previousIndex = this.slides.findIndex(s => s === this.currentSlide);
...
function getHighlightLanguages() {
    return {
        ...
        elm: () => __webpack_require__.e(/*! import() | highlight-js-lib-languages-elm */ "common").then(__webpack_require__.t.bind(null, /*! highlight.js/lib/languages/elm */ "./node_modules/highlight.js/lib/languages/elm.js", 7)),
        bash: () => __webpack_require__.e(/*! import() | highlight-js-lib-languages-bash */ "common").then(__webpack_require__.t.bind(null, /*! highlight.js/lib/languages/bash */ "./node_modules/highlight.js/lib/languages/bash.js", 7)),
        shell: () => __webpack_require__.e(/*! import() | highlight-js-lib-languages-shell */ "common").then(__webpack_require__.t.bind(null, /*! highlight.js/lib/languages/shell */ "./node_modules/highlight.js/lib/languages/shell.js", 7)),
    };
}
...
let GoogleMainComponent = class GoogleMainComponent {
    constructor() {
...
let DecoderExampleComponent = class DecoderExampleComponent {
    constructor() {
        this.code = `
...
let ElmExampleComponent = class ElmExampleComponent {
    constructor() {
        this.code = `
...
let ExampleCodeComponent = class ExampleCodeComponent {
    constructor() {
        this.htmlCode = `
        <ul>
            <li *ngFor="let item of (authorList$ | async).items">
...
let ExampleTemplateComponent = class ExampleTemplateComponent {
    constructor(store, actions$, authorListService) {
        this.store = store;
    ...
    ngOnInit() {
        if (this.case === 'default') {
            ...
            this.authorList$ = this.authorListService.getAuthorListInvalid().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(items => ({
                items,
                isLoading: false,
                error: ''
            })));
            ...
            this.authorList$ = this.authorListService.getAuthorListObjectObject().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(items => ({
                items,
                isLoading: false,
                error: ''
            })));
    ...
    loadWithDecoder(getInvalidData = false) {
        this.authorList$ = this.store.select(state => state.authorList);
        this.subscriptions.push(this.actions$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["filter"])(action => action.type === _store_actions__WEBPACK_IMPORTED_MODULE_4__["AuthorListActions"].LOAD_AUTHOR_LIST_FAILURE)).subscribe(action => console.log(action)));
...
let JsonPrinterComponent = class JsonPrinterComponent {
    constructor(authorListService) {
        this.authorListService = authorListService;
        this.case = 'default';
    }
    ngOnInit() {
...
JsonPrinterComponent.ctorParameters = () => [
...
let NgMainComponent = class NgMainComponent {
    constructor() {
        this.serviceCode = `
...
const loadAuthorList = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])(AuthorListActions.LOAD_AUTHOR_LIST);
const loadAuthorListInvalid = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])(AuthorListActions.LOAD_AUTHOR_LIST_INVALID);
const loadAuthorListSuccess = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])(AuthorListActions.LOAD_AUTHOR_LIST_SUCCESS, Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
const loadAuthorListFailure = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createAction"])(AuthorListActions.LOAD_AUTHOR_LIST_FAILURE, Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["props"])());
...
const AuthorItemDecoder = ts_data_json__WEBPACK_IMPORTED_MODULE_1__["JsonDecoder"].object({
...
const AuthorListDecoder = ts_data_json__WEBPACK_IMPORTED_MODULE_1__["JsonDecoder"].array(AuthorItemDecoder, 'AuthorItemDecoder[]');
...
let AuthorListEffects = class AuthorListEffects {
    constructor(actions$, authorListService) {
        this.actions$ = actions$;
        this.authorListService = authorListService;
        this.loadAuthorList$ = Object(_ngrx_effects__WEBPACK_IMPORTED_MODULE_2__["createEffect"])(() => this.actions$.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["filter"])(action => [_actions__WEBPACK_IMPORTED_MODULE_5__["AuthorListActions"].LOAD_AUTHOR_LIST, _actions__WEBPACK_IMPORTED_MODULE_5__["AuthorListActions"].LOAD_AUTHOR_LIST_INVALID].includes(action.type)), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["mergeMap"])(action => this.authorListService.getAuthorList(action.type === _actions__WEBPACK_IMPORTED_MODULE_5__["AuthorListActions"].LOAD_AUTHOR_LIST ? 'default' : 'invalid')
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(items => ({ type: _actions__WEBPACK_IMPORTED_MODULE_5__["AuthorListActions"].LOAD_AUTHOR_LIST_SUCCESS, payload: items })), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(error => Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])({ type: _actions__WEBPACK_IMPORTED_MODULE_5__["AuthorListActions"].LOAD_AUTHOR_LIST_FAILURE, payload: error.message }))))));
    }
};
AuthorListEffects.ctorParameters = () => [
...
const reducer = Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["createReducer"])(initialState, Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(_actions__WEBPACK_IMPORTED_MODULE_2__["loadAuthorList"], () => {
    return Object.assign({}, initialState, { isLoading: true });
}), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(_actions__WEBPACK_IMPORTED_MODULE_2__["loadAuthorListInvalid"], () => {
    return Object.assign({}, initialState, { isLoading: true });
}), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(_actions__WEBPACK_IMPORTED_MODULE_2__["loadAuthorListSuccess"], (state, action) => {
    return { items: action.payload, error: null, isLoading: false };
}), Object(_ngrx_store__WEBPACK_IMPORTED_MODULE_1__["on"])(_actions__WEBPACK_IMPORTED_MODULE_2__["loadAuthorListFailure"], (state, action) => {
...
let AuthorListService = class AuthorListService {
    constructor(http) {
        this.http = http;
    }
    getAuthorListSimple() {
    ...
    getAuthorList(scenario = 'default') {
        const path = scenario === 'default' ? 'assets/mocks/list.json' : 'assets/mocks/invalid-list.json';
        return this.http.get(path).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["concatMap"])(p => Object(rxjs_internal_compatibility__WEBPACK_IMPORTED_MODULE_4__["fromPromise"])(_decoder__WEBPACK_IMPORTED_MODULE_5__["AuthorListDecoder"]
            .decodePromise(p)
            .catch(e => {
            throw new Error(e);
        }))));
...
AuthorListService.ctorParameters = () => [
